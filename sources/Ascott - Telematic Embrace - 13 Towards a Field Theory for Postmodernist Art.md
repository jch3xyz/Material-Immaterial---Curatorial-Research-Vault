---
type: source_summary
title: "Towards a Field Theory for Postmodernist Art"
book: "Telematic Embrace"
author: "Roy Ascott"
raw_file: "raw/Ascott - Telematic Embrace/13 Towards a Field Theory for Postmodernist Art.md"
sha256: "8ea41db09d806c2812dd5b965a5966d93b5a6fabf28a75bee57962b89c7e369f"
sources:
  - "raw/Ascott - Telematic Embrace/13 Towards a Field Theory for Postmodernist Art.md"
status: generated
last_updated: 2026-06-08
---

# Source Summary: Towards a Field Theory for Postmodernist Art
...
This is the hinge essay of *Telematic Embrace* — the bridge from Ascott's 1960s cybernetic/behaviourist art to the 1980s telematic/network art that gives the volume its name. Delivered on the panel "Towards Post-Modernist Form" at the College Art Association Annual Conference (New York, February 1978) and first published in *Leonardo* 13, no. 1 (February 1980), it proposes "a field theory that would replace the formalist modernist aesthetic." The new paradigm "takes as its focus not form but behaviour": the artwork is not a one-way message to be decoded but "a matrix between two sets of behaviours (the artist and the observer)," a "field of psychic probability, highly entropic," in which "the final responsibility for meaning lies with the viewer." This is the clearest single statement of Ascott's career-spanning move from the artwork-as-object to the artwork-as-system, and from the spectator as passive receiver to the **participator** who completes the work.

Rhetorically the essay works by negation and by import. It first defines formalist modernism by what it "was not" — "connective, inclusive, transactional, associative, referential, interactive, changeable, discontinuous, multilayered, impure, ambiguous" — and then claims postmodernist art as the encompassing of exactly those qualities, a "connective paradigm, which in turn demands a connective criticism." Because the new model has no vocabulary inside art, Ascott reaches outward: to cybernetics (Wiener's information-as-transmission-of-alternatives), the new physics (Heisenberg's indeterminacy, the observer who is "part of what he is observing"), the new linguistics and Sufi thought (Eco's "gambling on the possibility of semiosis"), psi research (Vallée's physics of information), and Eastern spiritual models of consciousness (Capra's *The Tao of Physics*). The argument is built to interlock these previously unrelated fields rather than to close them.

For the vault this chapter is the strongest single primary-text anchor for EXTENDING the Burnham-realized systems/art cluster — [[New Media Art]], [[Art as Experiential Technology]], [[Reciprocal Communication]], [[Systems Esthetics]], [[Object and System]], [[Material vs Immaterial]] — from the Ascott (participatory/behavioural) pole, complementing Burnham's object→system spine from the other side of 1960s–70s systems-oriented art. It also announces a transition "from materialist culture" toward "the spiritual in art" — the 1980 seed of Ascott's later technoetics — and ends on a methodological commitment: networking as "the antithesis of reductionism," and inconclusiveness as "the essence of the postmodernist condition." The later coinages (telenoia, the telematic embrace, network consciousness, cyberception, technoetics) do NOT appear by name here; only their seeds.
...
- [[Object and System]] — EXTENDED/linked: the artwork reframed as a "system" and a "field" from the behavioural/participatory side of Burnham's object→system thesis.
- [[Systems Esthetics]] — linked: Ascott is the other 1960s–70s pole of systems-oriented art (behavioural/cybernetic vs Burnham's object→system). Cross-linked, not merged.
- [[Cybernetics]] — linked: Ascott explicitly aligns the field theory with cybernetics and cites Wiener.
- [[Information]] — linked: Wiener's "transmission of alternatives" sense, and the "paradigmatic shift from an information model for art."
- [[The Global Village]] — linked: the connective/networking paradigm is the art-theoretic kin of McLuhan's networked global village.
...
- [[A Field Theory of Art]] — "Art does not reside in the artwork alone, nor in the activity of the artist alone, but is understood as a field of psychic probability, highly entropic, in which the viewer is actively involved ... by interrogating and interacting with the system 'artwork' to generate meaning."
- [[The Participator]] — the viewer who "must be a participator and is of operational importance in the total behaviour of the system."
- [[Information]] — the cybernetic sense Ascott imports from Wiener: the transmission of information as "impossible save as a transmission of alternatives."
...
- The participator vs the spectator: pair Ascott's "field of psychic probability" with Burnham's object→system thesis and Hayles's [[The Observer]] to write the genealogy of the audience as constitutive system rather than receiver — a through-line for an essay on participation and embodiment in systems art.
- The spiritual turn in systems/new-media art: use the 1980 "moving towards the spiritual in art" passage as the seed of technoetics, cross-read with O'Gieblyn's [[Re-enchantment]], to argue that the material→immaterial trajectory in art was always also a re-enchantment trajectory.
- Networking as anti-reductionism: stage Ascott's "Networking is the antithesis of reductionism" against McLuhan's [[The Global Village]] for an essay on the connective paradigm as both a media condition and an aesthetic method.
- The Newtonian critique of the avant-garde: deploy "faux modernist" and "a totally Newtonian structure" in an essay arguing that progress-bound modernism inherited the very linear physics it claimed to break with.
...
Supports: [[A Field Theory of Art]], [[The Participator]], [[Object and System]] — the field-theory definition and the rejection of the closure/message model.
Confidence: Directly stated.
