...
author: "Don Norman"
part: "Human Error? No, Bad Design"
...
five: Human Error? No, Bad Design 171
...
five: Human Error? No, Bad Design 175
...
five: Human Error? No, Bad Design 177
...
five: Human Error? No, Bad Design 181
...
five: Human Error? No, Bad Design 187
...
cause of this accident was the flight crew’s failure to use engine anti ice during ground operation and takeoff, their decision to take off with
...
T H E C A S E O F T H E W R O N G T U R N O N A H I G H WAY
...
Establishing similar sterile periods would be of great benefit to many professions, including medicine and other safety-critical operations. My wife and I follow this convention in driving: when the driver is entering or leaving a high-speed highway,

conversa200 The Design of Everyday Things
...
### A DDI NG CONST R A I N TS TO BLO C K E R ROR S
...
### C O N F I R M AT I O N A N D E R R O R M E S S AG E S
...
frequent ones leads to capture errors, where the more frequent actions are performed rather than the correct ones for the situation. Procedures should be designed so that the initial steps are as dissimilar as possible. The important message is that good design can prevent slips and mistakes. Design can save lives.
...
Each of these has operational implications. More slices of cheese means mores lines of defense, such as the requirement in aviation and other industries for checklists, where one person reads the items, another does the operation, and the first person checks the operation to confirm it was done appropriately. Reducing the number of critical safety points where error can occur is like reducing the number or size of the holes in the Swiss cheese. Properly designed equipment will reduce the opportunity for slips and mistakes, which is like reducing the number of holes
...
every day, which has been achieved in large part through design redundancy and layers of defense.
...
Resilience engineering is a paradigm for safety management that focuses on how to help people cope with complexity under pressure to

achieve success. It strongly contrasts with what is typical today—a

paradigm of tabulating error as if it were a thing, followed by interventions to reduce this count. A resilient organisation treats safety as a core
...
five: Human Error? No, Bad Design 213
...
five: Human Error? No, Bad Design 215
