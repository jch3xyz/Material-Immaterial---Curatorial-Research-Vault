...
- [[Reading Pathways]] — curated nonlinear paths through the vault

## Start here — reading pathways

The best on-ramps are the **vault-wide pathways**, each tracing a single thread through the whole corpus:

- [[The Material and Immaterial axis end to end (Pathway)|The Material and Immaterial axis end to end]] — the vault's titular tension across twelve author sections
- [[From the spectacle to transparency to surveillance capitalism (Pathway)|From the spectacle to transparency to surveillance capitalism]] — the ancestor→descendant spine: Debord → Han → Zuboff
- [[Surveillance from the panopticon to Big Other (Pathway)|Surveillance from the panopticon to Big Other]] — Debord → Han → Harari → Zuboff
- [[The posthuman body (Pathway)|The posthuman body]] — Hayles → Haraway → Kurzweil → Ascott
- [[Art from object to system to network (Pathway)|Art from object to system to network]] — Burnham → Lippard → Ascott
- [[Cybernetics and systems across the vault (Pathway)|Cybernetics and systems across the vault]] — Meadows (the native-discipline primer) → Hayles → Burnham → Ascott
- [[The cyborg across the vault (Pathway)|The cyborg across the vault]] — Burnham 1968 → Haraway 1985 → Hayles → Ascott
- [[Information, the contested concept (Pathway)|Information, the contested concept]] — one word, twelve meanings
- [[The religious afterlife of technology (Pathway)|The religious afterlife of technology]] — O'Gieblyn, Harari, Kurzweil

See [[Reading Pathways]] for all **16 vault-wide** paths and **42 per-book** paths.

## Research foci

Concepts the vault is built to be particularly useful for:
