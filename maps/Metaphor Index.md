...
All metaphor notes in `metaphors/`, grouped by theme. (Symbols live in [[Symbol Index]].)

## Surveillance, Extraction and Dispossession

Zuboff's menagerie of parasites, predators, and conquest-by-declaration figures for surveillance capitalism — the apparatus that renders lived experience into behavioral surplus and the inevitabilism that numbs resistance to it.
...
## The Machine, the Automaton and Artificial Life

Figures for the made thing brought to life and the mind reimagined as mechanism — automata, robots, golems, and the long dispute over whether life can be magically or scientifically imitated.
...
- [[Mind as Machine]] — REALIZED (was a stub): the mind/brain as the era's dominant machine (clock, mill, telegraph, radio, computer); brain = hardware running the software of the mind; slides into literalism (O'Gieblyn)
...
- [[The Turing Test as a Magic Trick]] — the test secures early assumptions so you 'become posthuman' before making any identification
- [[The Universe as a Spendthrift Artist]] — Boulding via Burnham: the entropy of local order (Burnham)

## Religion, Soul and the Sacred

The disenchanted world and the drive to re-enchant it by technical means — idols and graven images, the mechanized crucifix, the golem, and the mind as microcosm of a cosmic consciousness.
...
- [[Graven Images]] — AI as failed imitation of life; 'all we can make are graven images' (O'Gieblyn)
...
- [[The Golem]] — the clay android animated by symbols; the pre-modern template for AI and its eschatological charge (O'Gieblyn)
- [[The Soul as an Empty Carapace]] — the soul as a dead metaphor; the disenchanted world as gears and levers (O'Gieblyn)

## Media, Extension and the Senses
...
## Network, Telematics and the Planetary Mind

Ascott's figures for the connective network as artwork and consciousness — the doorway that replaces the window, the cultivated moist medium, and nature reread as the first virtual reality.
...
## Acceleration, Exhaustion and Time

Han's figures for the achievement society that exploits itself to exhaustion, and the contemplative or dancing counter-figures that escape the logic of acceleration and the dissolving of narrative time.
...
## Transparency, the Veil and Sameness

Han's figures for the see-through subject and the regime of total positivity — the glassy human, the lightless radiation that homogenizes, the mask and veil it wars against, and the hell of the same.

- [[Hell of the Same]] — equivalence as monocultural inferno
- [[Lightless Radiation]] — sourceless suffusion that homogenizes rather than illuminates
- [[The Glassy Human]] — the subject rendered see-through by transparency
- [[The Veil]] — figure of negativity that makes beauty and eros possible
...
## Information, the Body and Dematerialization

The material/immaterial axis across cybernetics, art history, and transhumanism — information losing its body, the dematerialized art object, the cyborg made of signals, and the body recast as obsolescent or persisting pattern.
...
- [[Information Lost Its Body]] — the governing metaphor of Hayles's first story; information as a 'bodiless fluid' between substrates
...
- [[The Body as Congealed Metaphor]] — the body as sedimented, non-replicable evolutionary history machines do not share
- [[The Event Horizon of the Singularity]] — The historical Singularity as a black hole: a region of "unimaginably large values" bounded by an **event horizon** we cannot see past from outside. Just as the…
- [[The Light Bulb as Pure Information]] — McLuhan/Piene: art as energy and information (Burnham, Ch7)
- [[The Pattern in the Stream]] — Kurzweil's whirlpool/stream figure of the self as persisting pattern (via Wiener, Heraclitus) (O'Gieblyn)
