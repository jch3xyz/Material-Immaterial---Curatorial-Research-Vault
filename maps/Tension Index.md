...
- [[Material vs Immaterial]] — now realized across four author sections: Han (transparency/information; immaterial labour), Hayles, Lippard's art-historical dematerialization, and O'Gieblyn
...
- [[Material vs Immaterial]] — the vault's master axis, now spanning four author sections: Han (transparency/information, and Psychopolitics' immaterial labour that releases the body from production), Hayles (embodiment/disembodiment), Lippard's 'Dematerialization in Conceptual Art' (the art-historical instance and its internal matter-state rebuttals), and O'Gieblyn
...
- [[Human Exceptionalism vs Ontological Equality]] — privileging the human subject (imago dei) vs. dethroning it (deep ecology, the human as virus/glitch/error) (O'Gieblyn)
