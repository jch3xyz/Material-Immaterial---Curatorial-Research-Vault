...
All symbol notes in `symbols/`, grouped by theme. (Metaphors live in [[Metaphor Index]].)

## Surveillance, Extraction & the Rendered Self

Emblems of surveillance capitalism and the soft panopticon: smart devices that spy, conquest-by-declaration, leaked memos, and watchers who are loved rather than feared. The cases through which lived experience is rendered into behavioral data.
...
- [[Smart Dust]] — In Ray Kurzweil's *The Singularity Is Near*, "smart dust" is a real DARPA development program: "complex sensor systems not much bigger than a pinhead." Kurzweil…
...
## Automata, Robots & the Imitation of Life

The long lineage of made figures that mimic the living: clockwork ducks and cathedral clocks, cybernetic tortoises, the robot, and the machine pet that cannot be switched off. The recurring dream of building, or animating, an artificial creature.
...
- [[The Robot]] — In Burnham's history of automata, the robot is the modern, debased descendant of the human-looking automaton — the clanking folklore figure of what he calls "th…
...
## Art Objects, Instruments & the Dematerializing Artwork

Emblematic art-objects, anti-objects, and the instruments of vision across sculpture, conceptual, and telematic art: the irreplaceable masterpiece, the reconfigurable panel, the observer-completed glass, and the microscope that builds what it images. Markers of the migration from the precious object toward system, perception, and network.
...
## Media, Money & the Electric Extension

McLuhan's emblems of media as the message: pure-information light, money dissolving into credit, dreams sold in cans, and the golden world that models the automation age. The electric reversal staged in everyday artifacts.
...
## Cyborg, Computation & the Disembodied Mind

Figures of the human recoded as information and merged with the machine: the cyborg slogan and its blasphemy, command-control as condensed code, the Chinese Room, and the physical maximum of computation. The cybernetic body and mind made data.
...
- [[Janet Freed]] — the erased embodied transcriptionist (Freed/Freud) who shows information is never disembodied (Hayles)
- [[The Chinese Room]] — Searle's room reread (via Hutchins): the whole room, not Searle, knows Chinese — distributed cognition (Hayles)
...
## Religion, the Algorithm & the Sacred

Where the soul, ethics, and the divine meet the machine: submission to an inscrutable algorithmic sovereign, industrial farming as the test of the modern covenant, and the shamanic plant technology of consciousness. Symbols of meaning, the sacred, and disenchantment.
...
## Transparency, the Veil & the Watched Subject

Han's and Hayles's figures of positivity and negativity: the like-button as digital Amen, the mask as symbolic appearance, and Deleuze's paired animals of enclosure and modulation. Emblems of the see-through self and what transparency wars against.
