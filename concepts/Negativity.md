...
Han uses "negativity" paradoxically as a *positive* value: not absence in the sense of mere lack, but the constitutive force by which something becomes different from itself, distinguishes itself from what it is not, or withdraws from immediate availability. He inherits the term from [[Hegel]]: "Spirit has 'power,' according to Hegel, 'only by looking the negative in the face and tarrying with it'" (Ch.1). The "society of [[Positivity]]" — the smoothed, additive, see-through order Han diagnoses — is precisely the regime that "progressively dismantles negativity in favor of positivity" (Ch.1). Negativity is therefore Han's name for everything that resists frictionless circulation: the secret, the veil, the threshold, the mask, suffering, [[Theory]], the [[The Other|Other]]. (Label: `Directly stated`.)

Negativity is constitutive of thought. In the chapter on [[Acceleration]], Han writes that "negativity inhabits thinking, which causes it to experience what transforms it. The negativity of becoming-different-from-oneself proves constitutive of thinking." Thinking, unlike calculation, is *not* self-transparent: it betakes itself into the open, and the negativity of self-difference is what distinguishes [[Erfahrung vs Erlebnis (Han)|experience]] from mere [[Erfahrung vs Erlebnis (Han)|experiencing]]. The same logic governs [[Theory]], which "as a mode of highly selective narration, draws a line of distinction. On the basis of such negativity, theory is violent" (Ch.1). To think, to theorize, to narrate are all acts of negation — of cutting, selecting, refusing — without which the positive proliferates promiscuously. (Label: `Directly stated`.)
...
- [[Distance]] / [[The Mask|Mask]] — Forms of negativity in social and erotic life (Ch.3, Ch.6).
...
> Theory in the strong sense of the word is a phenomenon of negativity, too. It makes a decision determining what belongs and what does not. As a mode of highly selective narration, it draws a line of distinction. On the basis of such negativity, theory is violent.

Supports: Grounds the claim that negativity is the productive force of distinction and selection — without which theory degenerates into data comparison. Label: `Directly stated`.
...
> Precisely the negativity of the secret, the veil, and concealment incite desire and make pleasure more intense. That is why the seducer plays with masks, illusion, and appearances. Compulsive transparency annihilates room for the play [Spiel-Räume] of pleasure and desire [Lust]. Evidence admits deduction, not seduction.

Supports: Locates negativity in the libidinal economy: the secret, veil, and concealment are not lacks but conditions for eros. Pairs with the Hegelian register to show negativity operating across thinking and desire. Label: `Directly stated`.
...
> According to Hegel, negativity inhabits thinking, which causes it to experience what transforms it. The negativity of becoming-different-from-oneself proves constitutive of thinking. Herein lies its difference from calculating, which always remains self-identical.

Supports: Provides the canonical formulation of negativity as becoming-different-from-oneself — the formula that distinguishes thinking from calculation and underwrites Han's larger contrast between narrative and additive temporalities. Label: `Directly stated`.
...
Supports: Extends negativity into the topology of space and time — meaning arises at thresholds, and their elimination flattens narrative tension into transparent passage. Label: `Directly stated`.
