...
The art-historical shift, roughly 1966–1972, away from the art object as a unique material commodity toward work in which the idea is paramount and the material vehicle is ephemeral, cheap, or absent. The term is [[Lucy Lippard]]'s coinage and the organizing thread of her *Six Years*, but the same drive — from possessable object toward idea, system, or signal — is tracked from the side of sculpture by [[Jack Burnham]] and carried into the data network by [[Roy Ascott]].

## Longer Explanation

Dematerialization names not a style but a phenomenological tendency — a reweighting of values in which the material vehicle recedes behind the idea, the system, or the transmissible signal. The corpus reads it from three vantages on the same gradient, and the most exacting of them concedes at the outset that the word is a metaphor: matter does not disappear, only the value placed on it.

**Dematerialization as a deemphasis, conceded inaccurate.** For [[Lucy Lippard]] the term is a **deemphasis** rather than an abolition: "a process of dematerialization, or a deemphasis on material aspects (uniqueness, permanence, decorative attractive[ness])." In her companion definition of [[Conceptual Art|Conceptual art]] the same axis appears as a hierarchy of attention — "work in which the idea is paramount and the material form is secondary, lightweight, ephemeral, cheap, unpretentious and/or 'dematerialized.'" The term enters the literature with the **Lippard & Chandler 1968 essay** "The Dematerialization of Art" (*Art International*, February 1968), which diagnoses an "ultra-conceptual art that emphasizes the thinking process almost exclusively" and concludes that "such a trend appears to be provoking a profound dematerialization of art." Lippard grants from the start that the term is **inaccurate**: "it has often been pointed out to me that dematerialization is an inaccurate term, that a piece of paper or a photograph is as much an object, or as 'material,' as a ton of lead. Granted. But for lack of a better term I have continued to refer to a process of dematerialization." The concept is best read as the art-historical instance of the broader [[Material vs Immaterial]] axis: an attempt to make art "free of art-world commodity status" by lodging it in "the inexpensive, ephemeral, unintimidating character of the Conceptual mediums themselves." That hope ends in recuperation — Lippard records that the escape from commercialization was "for the most part unfounded": "art and artist in a capitalist society remain luxuries."

**The sculptural precursor.** [[Jack Burnham]]'s *Beyond Modern Sculpture* (1968) reaches the same value-reweighting from sculpture, a contemporaneous diagnosis arrived at independently of conceptual practice. He borrows Herbert Read's verdict that postwar sculpture undergoes a "tortuous dematerialization" reduced to a "scribble in the air" (its own metaphor note [[A Scribble in the Air]]) — "extension rather than containment, dynamicism instead of mass." The "withering away of the base" makes the drive concrete: once "completely liberated from its base" a sculpture "becomes a different animal! Its raison d'etre is no longer that it embodies formal qualities, but that it exists as a physical system including invisible forces. The duality between matter and energy enters a new phase." Burnham names the through-line as "the dialectical tension within twentieth-century sculpture" in its "steady gravitation toward seeming immateriality (through forms of attenuated and unstable materiality), while at the same time resisting this trend," and states the endpoint in [[Systems Theory|systems]] terms: "with Object Art physical presence is everything, while for Systems Art 'information' is the key factor." Burnham is a precursor, not a synonym — his object-to-system migration runs alongside the idea-paramount/material-secondary axis; the interpretive lineage is held in [[Jack Burnham and Lucy Lippard]].

**Extension into the network — and its reversal.** [[Roy Ascott]] carries dematerialization out of the 1960s conceptual moment into the data network, lodging the work in computer-mediated telecommunications. Editor Edward Shanken glosses the gain as Lippard's: "Telematics enables tremendous artistic freedom. It permits the artist to liberate art from its conventional embodiment in a physical object located in a unique geographic location." In Ascott's own "Art and Telematics," the dematerialized work is no longer a thing but a process in flux: "art itself becomes, not a discrete set of entities, but rather a web of relationships between ideas and images in constant flux, to which no single authorship is attributable, and whose meanings depend on the active participation of whoever enters the network" — the immateriality not merely of the idea but of the transmissible signal. His late "Moist Manifesto" then supplies the dialectical turn that distinguishes him: he inherits the object-to-process history — interactive media "replaced the cult of the *objet d'art* with a process-based culture" — but **re-materializes** the dematerialized digital into a "moist" register: "Between the dry world of virtuality and the wet world of biology lies a moist domain... Moistmedia (comprising bits, atoms, neurons, and genes in every kind of combination) will constitute the substrate of the art of our new century." Ascott is thus both the fulfilment of dematerialization — the artwork as weightless, authorless, networked information — and its reversal, the "dry" immateriality folded back into "molecules and matter," confirming the [[The Materiality of Informatics]] insistence that the immaterial is only ever differently embodied; the lineage is held in [[Roy Ascott and Lucy Lippard]].

Read together, these vantages agree that dematerialization is a real reweighting of values rather than a literal escape from matter — and the concept's own internal critics, in the **Art & Language** "matter-state" rebuttal and **Mel Bochner**'s insistence on physicality, press exactly that point against Lippard from within her own circle.

## Authors and Variants

- **[[Lucy Lippard]]** — coins and qualifies the term as the loose organizing thread of *Six Years*, explicitly "a deemphasis on material aspects" and explicitly conceding its inaccuracy; with critic John Chandler she authors the 1968 source essay "The Dematerialization of Art."
- **[[Jack Burnham]]** — reaches the same object-to-system reweighting from sculpture in *Beyond Modern Sculpture* (1968): the "vanishing base" turns the sculpture into "a physical system including invisible forces," and "with Object Art physical presence is everything, while for Systems Art 'information' is the key factor" — the sculptural precursor to Lippard's conceptual dematerialization.
- **[[Roy Ascott]]** — extends dematerialization into telematic, networked art (the artwork as a "web of relationships... in constant flux," no longer "a discrete set of entities"), then reverses it: his "moist" register folds the dry, immaterial digital back into "molecules and matter," making him both the fulfilment and the undoing of the de-emphasis.
...
- [[Material vs Immaterial]] — the cross-author axis of which dematerialization is the art-historical instance; link up, do not duplicate the tension here.
- [[Virtuality]] — Hayles's pattern/presence dialectic; dematerialized art prefigures the cultural valuation of information over instantiation.
- [[The Materiality of Informatics]] — the counter-insistence (shared with Art & Language and Bochner) that "immaterial" information always has a material substrate.
- [[Information]] — Conceptual art's substitution of "information and systems" for "traditional formal concerns of composition, color, technique, and physical presence."
- [[Systems Theory]] — the period's "systems aesthetics" (Haacke, Burnham); the working premise "to think in terms of systems."
- [[New Media Art]] — the ephemeral Conceptual mediums (video, performance, photo-text, mail art) seed later new-media practice.
- [[Art as Experiential Technology]] — the turn "from object to place" and toward "direct experience" reframes art as an instrument of perception rather than a possessable thing.

## Opposing Concepts

- [[Material vs Immaterial]] — dematerialization sits on the immaterial pole, but its own internal critics (Art & Language, Bochner) re-assert the material pole, making the concept the staging ground for the opposition rather than a settled resolution of it.

## Questions It Raises

- If dematerialization is conceded to be inaccurate — paper and photographs remain objects — what exactly is being de-emphasized: matter, or *value placed on* matter (uniqueness, permanence, possession)? How does this map onto the [[Material vs Immaterial]] axis as the user reads it?
...
Supports: Lippard's own operational gloss ("a deemphasis on material aspects") together with her explicit concession that the term is inaccurate — the dual definition required for this note. Speaker: Lippard. Label: `Directly stated`.
...
Supports: The "idea paramount / material vehicle secondary" framing that defines dematerialization as a hierarchy of attention rather than a literal disappearance of matter. Speaker: Lippard. Label: `Directly stated`.

### Source 3

Book: *Six Years*
Author: Lucy Lippard (quoting the Lippard & Chandler 1968 essay)
Raw file: [[raw/Lippard - Six Years/07 1968]]
Relevant passage:

> Such a trend appears to be provoking a profound dematerialization of art.

Supports: The Lippard & Chandler source essay "The Dematerialization of Art" (*Art International*, February 1968), the term's point of origin, here documented in the year-by-year chronicle. Speaker: Lucy Lippard and John Chandler. Label: `Directly stated`.
...
Supports: The internal dissent — the Art & Language matter-state rebuttal that no work is truly dematerialized, only changed in state; anchors the link to [[The Materiality of Informatics]]. Speaker: the Art-Language group (letter-essay to Lippard and Chandler, March 1968). Label: `Directly stated`.

### Source 5

Book: *Six Years*
Author: Lucy Lippard (quoting Mel Bochner)
...
Supports: The second strand of internal dissent — the insistence that physicality is an inescapable "burden," reinforcing dematerialization as a contested metaphor rather than a literal fact. Speaker: Mel Bochner, "Elements from Speculation (1967–1970)," 1970. Label: `Directly stated`.
