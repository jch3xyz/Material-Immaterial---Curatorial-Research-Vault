...
Haraway's feminist anti-humanism is the historical root beneath all four, and Hayles's "tradition of liberal humanism" foil is its direct descendant — but the root and its heirs must not be merged: Haraway's cyborg is a *politics of refusal* (a myth to be deployed against the universal Western self), not, like the four, a description, eschatology, forecast, or affirmation of a coming *state*. The four are themselves genealogically linked but must not be merged. Hayles supplies the *critical concept* and O'Gieblyn supplies its *eschatological enactment*: what Hayles calls the "lethal graft" — the posthuman grafted onto liberal humanist autonomy and mastery — is precisely what O'Gieblyn's transhumanism *performs*. Harari then marks the terminus the first two circle around: where transhumanism *promises* an immortal upgraded self, Harari's Dataism dispenses with the self altogether — the same pattern-over-matter premise carried to the point where the human is not transcended but functionally surplus. Kurzweil completes the spread as its *believing pole* — the one author here who is himself the target O'Gieblyn anatomizes and the proponent whose optimism Harari's obsolescence pole inverts: he affirms the predominance of nonbiological intelligence and insists it is still *human*, the [[Material vs Immaterial|immaterial]] pole stated not as warning but as welcome. For the program (and the upgraded "superhuman") as such, see the distinct concept [[Transhumanism]]; the sections below treat O'Gieblyn's argument that the program is secular eschatology, Harari's that it ends in human obsolescence, and Kurzweil's that it is humanity's next evolutionary step.

## Longer Explanation

Hayles insists that the posthuman names a **point of view**, characterized by four assumptions that she is careful to call "suggestive rather than prescriptive." *First*, it "privileges informational pattern over material instantiation, so that embodiment in a biological substrate is seen as an accident of history rather than an inevitability of life." *Second*, it treats consciousness — long held in the West to be the seat of identity — "as an epiphenomenon, as an evolutionary upstart trying to claim that it is the whole show when in actuality it is onlya minor sideshow." *Third*, it "thinks of the body as the original prosthesis we all learn to manipulate," so that extending or replacing the body with other prostheses (see [[The Extrapolated Body]]) merely continues a process begun before birth. *Fourth, and most important*, it "configures human being so that it can be seamlessly articulated with intelligent machines." The decisive move is that the posthuman is a matter of how subjectivity is constructed, not of hardware: "the construction of the posthuman does not require the subject to be a literal cyborg ... even a biologically unaltered Homo sapiens counts as posthuman."

Crucially, Hayles distinguishes the posthuman from its predecessor and foil, [[The Liberal Humanist Subject]], while showing that the two share a fatal inheritance. The liberal subject "possessed a body but was not usually represented as being a body"; its notorious universality depended on erasing markers of bodily difference. Because [[Information]] in the cybernetic tradition was constructed as a disembodied pattern (Shannon's "pattern, not a presence"), the posthuman that grew out of [[Cybernetics]] "shares with its predecessor an emphasis on cognition rather than embodiment." Where the body appears at all, it appears as William Gibson's "data made flesh" (see [[The Body as Data]]) — embodiment recoded as the mere instantiation of thought/information. In this sense the cybernetic posthuman "continues the liberal tradition rather than disrupts it."
