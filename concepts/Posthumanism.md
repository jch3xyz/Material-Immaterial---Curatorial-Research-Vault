...
*Posthumanism* names the condition, point of view, or program in which the bounded, autonomous human of Western humanism is dissolved, displaced, or surpassed — typically by privileging informational pattern over material instantiation, and by articulating the human seamlessly with technology. Its canonical statement here is [[N. Katherine Hayles]]'s: the posthuman is not a literal cyborg but **a point of view** — a construction of subjectivity that can be "seamlessly articulated with intelligent machines" — and it marks "the end of[a] certain conception of the human," the liberal humanist one, not the end of humanity. Around that analytic core the vault holds several distinct uses of the word that must not be collapsed: a *politics of refusal* ([[Donna Haraway]]), *media-theoretic* and *art-theoretic* precursors ([[Marshall McLuhan]], [[Jack Burnham]]), an *eschatological program* ([[Meghan O'Gieblyn]]), a *data-centric obsolescence* ([[Yuval Noah Harari]]), and *affirmative* projections of transcendence or convergence ([[Ray Kurzweil]], [[Roy Ascott]]).

## General Orientation

The word *posthuman* carries several distinct senses in this vault, and the note keeps them separate rather than merging them into a single doctrine. They share one premise — that the bounded individual "Man" of Western humanism is on the way out, and that what supersedes it turns in some way on *pattern, information, or system over matter* — but they differ sharply in mode: politics, diagnosis, precursor projection, eschatology, forecast, and affirmation are not the same act, and the note sorts its authors by which they perform.

**Precursors (description of a horizon, not yet a politics or a program).** [[Marshall McLuhan]] supplies the *media-theoretic* precursor: in *Understanding Media* (1964), technologies are [[Media as Extensions of Man|extensions of man]], electric media extend "our central nervous system itself in a global embrace," and McLuhan projects "the final phase of the extensions of man— the technological simulation of consciousness ... collectively and corporately extended to the whole of human society" (`Directly stated`). The bounded literate self is rendered obsolete — "in the electric age we wear all mankind as our skin"; "man becomes ... the sex organs of the machine world" — and dissolved not into a data flow or a silicon substrate but into a *collectivized*, planet-wide consciousness (see [[The Technological Extension of Consciousness]], [[The Global Village]], [[Man as Servomechanism of His Extensions]]). [[Jack Burnham]] supplies the *art-theoretic* precursor: *Beyond Modern Sculpture* (1968) reads modern abstraction as "psychic preparation for the entire re-creation of society, including remaking the biological composition of its inhabitants" (`Directly stated`), with sculpture as a "psychical radar signal" readying the human race for self-inflicted evolution into a "post-human species" (see [[Cyborg Art]]). Both arrive at the pattern-over-matter horizon — McLuhan from media, Burnham from aesthetics — that the later authors inhabit without naming.

**The anti-humanist root.** [[Donna Haraway]]'s *A Cyborg Manifesto* (1985) is a *politics, not a prediction*: the cyborg is a feminist political myth aimed at "Man, the embodiment of Western logos," the universal self built from dualisms (self/other, mind/body, culture/nature, male/female, maker/made). "In the 'Western' sense, the end of man is at stake. It is no accident that woman disintegrates into women in our time" (`Directly stated`). It refuses three things at once — the universal subject, organic wholeness, and original unity ("I would rather be a cyborg than a goddess"). This is the root [[N. Katherine Hayles]] draws on, the source from which she takes the boundary-crossing, fractured self; but Haraway *deploys* the cyborg where the others *describe*, *forecast*, or *welcome* a coming state.

**The critical core.** [[N. Katherine Hayles]] converts Haraway's polemical cyborg into an analytic **point of view**: the posthuman names *how subjectivity is constructed* once [[Information]] is privileged over [[Embodiment]], and it "does not require the subject to be a literal cyborg." It is descriptive, ambivalent, and contestable — Hayles maps the condition ("we have always been posthuman") in order to argue for a *benign, embodied* version rather than a lethal one (see the Longer Explanation).

**The eschatological unmasking.** [[Meghan O'Gieblyn]] takes the same pattern-over-matter premise as it appears in *transhumanism* (Kurzweil, Bostrom, Moravec) and argues it is "an outgrowth of Christian eschatology" — a resurrection narrative in technical dress where uploading is resurrection and the Singularity is the *parousia*. "What makes transhumanism so compelling is that it promises to restore through science the transcendent—and essentially religious—hopes that science itself obliterated" (`Directly stated`). This is precisely Hayles's "lethal graft" *enacted*: the posthuman fused to liberal-humanist autonomy and made immortal. The program as such is treated under [[Transhumanism]].

**The obsolescence pole.** [[Yuval Noah Harari]] supplies the data-centric endgame, in which the human is neither saved nor contested but *retired*. Driven by [[Dataism]], the displacement that humanism worked on God is now worked by data on the human: "In the eighteenth century, humanism sidelined God ... In the twenty-first century, Dataism may sideline humans" (`Directly stated`). As intelligence decouples from consciousness, *Homo sapiens* becomes "an obsolete algorithm," "retired" like the horse and dissolved into the cosmic data flow. (This is the opposite face of Harari's upgraded "superhuman," treated under [[Transhumanism]]; he flags the obsolescence pole as a conditional limit case, not a prophecy.)

**The affirmative poles.** [[Ray Kurzweil]] is the *believing* pole — the proponent's statement of everything the critics circle: nonbiological intelligence will predominate, yet "future machines will be human, even if they are not biological. This will be the next step in evolution" (`Directly stated`). The human/machine distinction dissolves *upward* (machines becoming human, the inverse of Harari's downward retirement), and biology — defective "version 1.0" hardware — is transcended (see [[Transcending Biology]], [[The Singularity]]). [[Roy Ascott]] is the *technoetic, convergent* pole: writing from telematic-art practice (1994–2000), he names a "post-biological faculty of 'cyberception'" in which "the sense of the individual is giving way to the sense of the interface ... We are all interface" (`Directly stated`), and forecasts not an escape from matter but its *fusion* with the digital and the spiritual — the "moist domain" of [[Moistmedia]] ("bits, atoms, neurons, and genes"), a posthuman that "will seek new forms of embodiment" through art rather than engineering.

The through-line: Haraway *refuses* the universal self; McLuhan and Burnham *project* its dissolution from media and art; Hayles *diagnoses* the point of view that supersedes it and pleads for an embodied version; O'Gieblyn *unmasks* the salvation program built on it; Harari *forecasts* its terminal obsolescence; and Kurzweil and Ascott *welcome* the transformation — Kurzweil as substrate-transcendence, Ascott as dry/wet/numinous convergence. The pattern-over-matter premise is common to all but stated as warning, refusal, forecast, or welcome depending on who holds it.

## Longer Explanation

The analytic spine of the note is [[N. Katherine Hayles]]'s claim that the posthuman names a **point of view**, characterized by assumptions she calls "suggestive rather than prescriptive." It "privileges informational pattern over material instantiation, so that embodiment in a biological substrate is seen as an accident of history rather than an inevitability of life"; it treats consciousness as "an epiphenomenon ... a minor sideshow"; it "thinks of the body as the original prosthesis we all learn to manipulate" (see [[The Extrapolated Body]]); and, most important, it "configures human being so that it can be seamlessly articulated with intelligent machines." The decisive move is that the posthuman is a matter of *how subjectivity is constructed*, not of hardware: "the construction of the posthuman does not require the subject to be a literal cyborg ... even a biologically unaltered Homo sapiens counts as posthuman" (`Directly stated`).

Hayles distinguishes the posthuman from its predecessor and foil, [[The Liberal Humanist Subject]], while showing the two share a fatal inheritance. The liberal subject "possessed a body but was not usually represented as being a body"; its universality depended on erasing bodily difference. Because [[Information]] in the cybernetic tradition was constructed as a disembodied pattern, the posthuman that grew out of [[Cybernetics]] "shares with its predecessor an emphasis on cognition rather than embodiment." Where the body appears at all it appears as Gibson's "data made flesh" (see [[The Body as Data]]) — embodiment recoded as the instantiation of thought. Her political claim follows: "the posthuman does not really mean the end of humanity. It signals instead the end of[a] certain conception of the human" — one that "applied, at best, to that fraction of humanity who had the wealth, power, and leisure to conceptualize themselves as autonomous beings" (`Directly stated`). "What is lethal is not the posthuman as such but the grafting of the posthuman onto a liberal humanist view of the self." Against that lethal graft Hayles posits a *benign* posthuman "grounded in embodied actuality rather than disembodied information" — and because "posthumanity is already here," the live question is no longer whether but "what kind of posthumans we will be" (`Directly stated`).

Every other author in the note can be plotted against this diagnosis. [[Donna Haraway]] is the root beneath Hayles's foil: both refuse the universal autonomous self (Hayles's possessive-individualist subject, Haraway's "Man, the embodiment of Western logos") and both locate the human in fractured, boundary-crossing assemblages ("we find ourselves to be cyborgs, hybrids, mosaics, chimeras"). But Haraway's cyborg is "a myth ... waiting to become a political language ... in order to act potently," a refusal of the universal subject, organic wholeness, and original unity — a *politics*, not a point of view to be mapped (see [[Fractured Identities]]). [[Marshall McLuhan]] and [[Jack Burnham]] are the precursors who reach the same pattern-over-matter horizon by other routes: McLuhan from media, projecting consciousness "collectively and corporately extended to the whole of human society" and the human "translated ... into the form of information" until the species fuses into "a single consciousness"; Burnham from aesthetics, reading abstraction as the species' rehearsal of "remaking the biological composition of its inhabitants" and art as a "radar signal" preparing a "post-human species." Neither names the posthuman subject Hayles maps, but both supply the prior premise from which it becomes thinkable.

The remaining authors take the pattern-over-matter premise and run it to opposed conclusions. [[Meghan O'Gieblyn]] shows that *transhumanism* (Kurzweil, Bostrom, Moravec) rests on the same cybernetic move — "disembodied information becomes the ultimate Platonic Form," Hayles's phrase, quoted by O'Gieblyn — but grafts it onto the liberal dream of an autonomous self made *immortal*: it is Hayles's lethal graft "enacted," and, despite promising "a portal into a higher realm," it actually "nudg[es] us down to a lower ontological status" (`Directly stated`). [[Yuval Noah Harari]] carries the premise past O'Gieblyn's promised immortality to its terminal consequence: where transhumanism keeps the liberal self and makes it eternal, [[Dataism]] keeps the *data* and discards the self. *Homo sapiens* becomes "an obsolete algorithm," retired like the horse and dissolved "within the data torrent like a clump of earth within a gushing river" — "humanity will turn out to be just a ripple within the cosmic data flow" (`Directly stated`). [[Ray Kurzweil]] states the same fusion Hayles warns against as *good news*: "future machines will be human, even if they are not biological. This will be the next step in evolution" — the human/machine distinction dissolving *upward*, biology transcended while "our civilization will remain human" (see [[Transcending Biology]], [[The Singularity]]). And [[Roy Ascott]] proposes a third path that refuses the dematerializing vector altogether: against escape *from* matter, his technoetic posthuman is a *convergence* of "the dry world of virtuality and the wet world of biology" in a "moist domain" ([[Moistmedia]]), a network-extended, transformable being that "will seek new forms of embodiment" — the affirmative pole routed through art, shamanism, and the [[Re-enchantment]] of a sentient cosmos rather than engineering.

Read together, the note's authors agree that the bounded humanist subject is finished and disagree about what that means: a politics to be deployed (Haraway), a horizon already glimpsed in media and art (McLuhan, Burnham), a condition to be diagnosed and embodied (Hayles), a salvation program to be unmasked (O'Gieblyn), an obsolescence to be reckoned with (Harari), or a transformation to be welcomed (Kurzweil, Ascott). Because Hayles makes the posthuman *performative* — "People become posthuman because they think they are posthuman" — and its meaning is still being decided, she treats the present as the moment to contest it: "The best possible time to contest for what the posthuman means is now."
...
## The Cyborg as Anti-Humanist Figure (Haraway)

Before Hayles diagnoses the posthuman as a point of view, before O'Gieblyn unmasks transhumanism, before Harari forecasts obsolescence and Kurzweil affirms transcendence, Donna Haraway's *A Cyborg Manifesto* supplies the **foundational anti-humanist gesture** the others sit atop: the cyborg as a *political myth* whose target is "Man" — the universal Western self that grounds the very humanism the later authors describe departing from. Haraway's posthumanism is **feminist**, and it is a *politics*, not a prediction. Its enemy is the figure she calls the author of history and of the cosmos: in "Fractured Identities" she names the breakup of "the symbolic system of the family of man—and so the essence of woman," and states the stakes flatly: "**In the “Western” sense, the end of man is at stake. It is no accident that woman disintegrates into women in our time.**" The two halves of that sentence are one move — the dissolution of the universal masculine subject ("Man") and the shattering of "woman" into the irreducibly plural "women" are the same event, because the universal self was always purchased by suppressing difference (`Directly stated`). This is anti-humanism in a sense the four later senses are not: not the human *upgraded*, *retired*, *welcomed*, or *reconceived as information*, but the universal humanist subject *refused* as a tool of domination — what Haraway elsewhere in the chapter ties to "the justifications for patriarchy, colonialism, humanism, positivism, essentialism, scientism."

The cyborg is the figure that enacts this refusal. In "Cyborgs: A Myth of Political Identity" Haraway grounds it ontologically in the collapse of the dualisms that structure the Western self: "Insofar as we know ourselves in both formal discourse (for example, biology) and in daily practice (for example, the homework economy in the integrated circuit), we find ourselves to be cyborgs, hybrids, mosaics, chimeras." Because "[t]here is no fundamental, ontological separation in our formal knowledge of machine and organism," the cyborg dissolves "self/other, mind/body, culture/nature, male/female, civilized/primitive ... maker/made ... God/man" — the apparatus by which "the One who is not dominated" constitutes the other "whose task is to mirror the self" (`Directly stated`). Crucially, Haraway's anti-humanism is also a refusal of **organic wholeness** and **original unity**: "Cyborg writing must not be about the Fall, the imagination of a once-upon-a-time wholeness before language, before writing, before Man," and "no construction is whole." The cyborg "is not innocent; it was not born in a garden; it does not seek unitary identity." This is why she sets it against the goddess of organicist and ecofeminist politics — "I would rather be a cyborg than a goddess" — and prefers "regeneration" to "rebirth," refusing "the reproductive matrix" and its dream of return to "original symbiosis" (`Directly stated`).

This is the precise sense in which Haraway is the *root Hayles draws on*, and the contrast is exact. Both refuse the universal autonomous self — for Hayles, [[The Liberal Humanist Subject]] of possessive individualism; for Haraway, "Man, the embodiment of Western logos" — and both locate the human in fractured, boundary-crossing assemblages rather than in a self-possessed interior. But Hayles converts Haraway's *polemical, oppositional* cyborg into an analytical **point of view** (a construction of subjectivity that privileges pattern over instantiation), and is careful to say the posthuman "does not require the subject to be a literal cyborg." Haraway's cyborg, by contrast, is not a point of view to be mapped but a *myth to be deployed* — "a myth system waiting to become a political language ... in order to act potently." Her anti-humanism is therefore distinct from all four senses below: not Hayles's diagnostic stance, not O'Gieblyn's secularized eschatology, not Harari's data-centric obsolescence, and not Kurzweil's evolutionary affirmation, but a **feminist refusal of the universal Western self** — a politics of "affinity, not identity," of "permanently unclosed constructions of personal and collective selves." Where Kurzweil welcomes a coming transcendence and Harari forecasts a coming dissolution, Haraway is not forecasting a state at all; she is, in the present tense, refusing the self that humanism universalized and proposing the cyborg as the figure of that refusal (`Interpretive synthesis`). She is, in this note, also the foundational anti-humanist root that the [[Fractured Identities]] of subjectivity make available — the identities that "seem contradictory, partial, and strategic," with "gender, race, and class" no longer able to "provide the basis for belief in 'essential' unity."
...
- **[[Marshall McLuhan]]** — the **media-theoretic precursor** (*Understanding Media*, 1964). Technologies as [[Media as Extensions of Man|extensions of man]]; electric media extend the central nervous system "in a global embrace"; the projected "final phase of the extensions of man— the technological simulation of consciousness ... collectively and corporately extended to the whole of human society." Bounded literate "Man" is rendered obsolete ("in the electric age we wear all mankind as our skin"; "man becomes ... the sex organs of the machine world") and dissolved into a single planetary consciousness. His terminus is the *collectivization* of consciousness, not the self's erasure or its immortal upload (see [[The Technological Extension of Consciousness]], [[The Global Village]], [[Man as Servomechanism of His Extensions]]).
- **[[Jack Burnham]]** — the **art-theoretic precursor** (*Beyond Modern Sculpture*, 1968). Reads modern abstraction as "psychic preparation for the entire re-creation of society, including remaking the biological composition of its inhabitants," with sculpture as a "psychical radar signal" readying the human race for self-inflicted evolution into a "post-human species," and art crossing into "true intelligence" and "reciprocal relationships" that render the "viewer" obsolete. The posthuman reached from aesthetics; flagged by Burnham as speculative (see [[Cyborg Art]]).
- **[[Donna Haraway]]** — the **anti-humanist root** (*A Cyborg Manifesto*, 1985). The cyborg as a *feminist political myth* against "Man, the embodiment of Western logos": "the end of man is at stake ... woman disintegrates into women." It refuses the universal subject, organic wholeness, and original unity ("I would rather be a cyborg than a goddess"). A *politics of refusal*, not a forecast — the historical source Hayles draws on (see [[Fractured Identities]], [[The Liberal Humanist Subject]]).
- **[[N. Katherine Hayles]]** — the **critical point of view** (*How We Became Posthuman*). The posthuman as a construction of subjectivity that privileges pattern over instantiation and "does not require the subject to be a literal cyborg"; the end of [[The Liberal Humanist Subject]], not of humanity; lethal only when grafted onto liberal humanism; redeemable as a *benign, embodied* posthuman grounded in [[Embodiment]]. "The question is what kind of posthumans we will be."
- **Hans Moravec (Hayles's antagonist)** — the "apocalyptic" posthuman: a "postbiological" future in which consciousness is downloaded into a computer and machines displace humanity. For Hayles this is precisely the posthuman *grafted onto liberal humanism* (autonomy and mastery extended into immortality), the version she contests.
- **[[Meghan O'Gieblyn]]** — the **eschatological unmasking** (*God Human Animal Machine*). Treats the transhumanist posthuman (Kurzweil, Bostrom, Moravec) as posthumanism's "religious double": a Christian resurrection narrative in technical dress (uploading = resurrection, the Singularity = parousia), "an outgrowth of Christian eschatology" that "nudg[es] us down to a lower ontological status." Hayles's "lethal graft" enacted. Treated in its own right as [[Transhumanism]].
- **[[Yuval Noah Harari]]** — the **obsolescence pole** (*Homo Deus*). Driven by [[Dataism]], the "deo-centric → homo-centric" displacement humanism worked on God is turned by data on the human ("homo-centric → data-centric"). As intelligence decouples from consciousness, *Homo sapiens* becomes "an obsolete algorithm," "retired" like the horse and dissolved into the "cosmic data flow"; the species "will vanish." Distinct from Harari's upgraded "superhuman" (the deification pole, treated under [[Transhumanism]]); stated as a conditional limit case, not a prophecy.
- **[[Ray Kurzweil]]** — the **believing pole** (*The Singularity Is Near*). The proponent's affirmative statement of what the critics treat warily: nonbiological intelligence predominates, yet "future machines will be human, even if they are not biological" — the "next step in evolution." The human/machine distinction dissolves *upward* ("machines will have progressed to be like humans and beyond"), the inverse of Harari's downward "retire *Homo sapiens*"; biology is transcended (see [[Transcending Biology]], [[The Singularity]]) and the human relocated from flesh into a quality ("we will transcend biology, but not our humanity"). Hayles's "lethal graft" welcomed, not warned against; the text O'Gieblyn anatomizes as resurrection theology.
- **[[Roy Ascott]]** — the **technoetic, convergent pole** (*Telematic Embrace*, 1994–2000). A "post-biological faculty of 'cyberception'" in which "the sense of the individual is giving way to the sense of the interface ... We are all interface" — the [[Distributed Cognition|distributed self]] dissolving [[The Liberal Humanist Subject]]. Not pattern-over-matter escape but *convergence*: the "moist domain" of [[Moistmedia]] ("bits, atoms, neurons, and genes"), "digitally dry, biologically wet, and spiritually numinous," a transformable being that "will seek new forms of embodiment" through art and the [[Re-enchantment]] of a sentient cosmos. Resonant with Kurzweil's [[Transcending Biology]] but routed through art rather than engineering.

## Related Concepts

- [[Embodiment]] — the term the benign posthuman recovers; "human being is first of all embodied being"
- [[The Cyborg]] — the technological/cultural *figure*; the posthuman is the *point of view*, which "does not require the subject to be a literal cyborg"
- [[Cybernetics]] — the tradition (three waves) within which the posthuman was constructed
- [[Feedback Loops]] — the circuits that put "the boundaries of the autonomous subject ... up for grabs"
- [[Virtuality]] — "the cultural perception that material objects are interpenetrated by information patterns," the condition in which the posthuman becomes "an everyday, lived reality"
- [[The Body as Data]] — Gibson's "data made flesh"; the posthuman body as instantiated pattern
...
- [[The Liberal Humanist Subject]] — the posthuman's predecessor and foil: the autonomous, self-possessed, rational-minded subject (Macpherson's possessive individualism). The posthuman "deconstructs" it (distributed cognition, owned-not-natural parts, no a priori self-will) — yet *shares* its erasure of [[Embodiment]]. The opposition is therefore partial: rupture in the construction of subjectivity, continuity in the privileging of mind over body.

## Questions It Raises

- If the posthuman privileges pattern over instantiation, does recovering [[Embodiment]] require rejecting the posthuman, or only the version "grafted onto a liberal humanist view of the self"? (ties to embodiment; posthumanism)
...
Supports: The first of the four assumptions defining the posthuman *as a point of view* — the privileging of pattern over instantiation that subordinates embodiment to information. Label: `Directly stated`.
...
> Although these examples foreground the cybernetic aspect of the posthuman, it is important to recognize that the construction of the posthuman does not require the subject to be a literal cyborg.

Supports: Grounds the central distinction of this note — the posthuman is a construction of subjectivity (a point of view), not the figure of [[The Cyborg]]; even an unaltered human "counts as posthuman." Label: `Directly stated`.
...
> People become posthuman because they think they are posthuman.

Supports: The performative dimension of the posthuman — it is constituted through self-description and belief, not only through technological alteration. Label: `Directly stated`.
...
Supports: Names the posthuman's predecessor/foil ([[The Liberal Humanist Subject]] / possessive individualism) and the fourth, "most important" assumption — seamless articulation with intelligent machines once computation becomes the ground of being. Label: `Directly stated`.
...
Supports: The claim that the posthuman is already our condition, shifting the stakes from prediction to a contestable choice — "what kind of posthumans we will be." Label: `Directly stated`.
...
Supports: Hayles's key move — the posthuman ends a *particular (liberal) conception* of the human, not humanity itself; that conception was historically restricted to the privileged few. Label: `Directly stated`.
...
Supports: The distinction between the dangerous and the benign posthuman — lethality lies in the fusion with liberal humanist autonomy/mastery, not in the posthuman per se. Label: `Directly stated`.
...
Raw file: [[raw/Haraway - A Cyborg Manifesto/02 [Fractured Identities]]]
Relevant passage:

> In the “Western” sense, the end of man is at stake. It is no accident that woman disintegrates into women in our time.

Supports: The foundational anti-humanist gesture predating the four senses — the dissolution of the universal Western self ("Man") and the shattering of "woman" into the irreducibly plural "women" as a single move; Haraway's feminist refusal of the universal subject and original/essential unity. Label: `Directly stated`.
