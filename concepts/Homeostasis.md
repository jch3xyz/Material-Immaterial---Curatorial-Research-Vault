...
For [[N. Katherine Hayles]], homeostasis is first of all an inherited biological idea: "Traditionally, homeostasis had been understood as the ability of living organisms to maintain steady states when they are buffeted by fickle environments." Her own gloss is concrete — "When the temperature soars, sweat pours out of the human body so that its internal temperature can remain relatively stable." The decisive cybernetic move of the Macy period was to extend this from organisms to machines: "Like animals, machines can maintain homeostasis using feedback loops." Steam-engine governors had long stabilized mechanical systems, but only in the 1930s and 1940s was the feedback loop "explicitly theorized as a flow of information." Homeostasis is thus the concept that let the same stabilizing logic run indifferently through animals, humans, and machines — the founding equivalence of [[Cybernetics]].

What makes homeostasis the *period-defining* concept, in Hayles's reading, is that it names not an isolated idea but a whole constellation of mutually reinforcing commitments. The first wave "took homeostasis as a central concept," and the Macy chapter "explores the elements that came together to form the homeostasis constellation." Its load-bearing alliance is with information conceived as a *thing*: "Making information a thing allies it with homeostasis, for so defined, it can be transported into any medium and maintain a stable quantitative value, reinforcing the stability that homeostasis implies." On the same side fall the signal/noise distinction and instrumental language — "Thus the construction of information as a signal/noise distinction and the privileging of homeostasis produced and were produced by each other" — while ambiguity, allusion, and metaphor were sorted onto the side of [[Reflexivity]]. To privilege homeostasis is to imagine the goal of a system as "less a specific site than stability itself."

Hayles's most pointed claim is that homeostasis prevailed not because it was truer but because it was *tractable*: "Homeostasis won in the first wave largely because it was more manageable quantitatively. Reflexivity lost because specifying and delimiting context quickly ballooned into an unmanageable project." She immediately denaturalizes the victory — "these outcomes are tied to the historical contingencies of the situation," and "Conceptualizing information as a disembodied entity was not an arbitrary decision, but neither was it inevitable." The postwar setting reinforced the choice: amid "the hysteria of McCarthyism, homeostasis implied a return to normalcy in more than one sense." Homeostasis, in other words, is where Hayles locates the *contingent* installation of [[Embodiment vs Information|information as disembodied stability]] — the moment the body could begin to become [[The Body as Data|data]].
