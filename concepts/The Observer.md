...
Across the corpus the observer carries two related but distinct loads. One strand treats the watcher as an *epistemological* figure — the question of where the one who describes a system stands relative to that system. The other treats the watcher as an *aesthetic* figure — the spectator whose action completes or constitutes an artwork. Both strands converge on a single move: the detached, external observer is folded into the system it had been imagined to stand outside of.

In *How We Became Posthuman* the epistemological observer is a load-bearing figure that moves across all three waves of cybernetics, and its movement is the plot. In the **first wave** (the Macy Conferences, roughly 1943–1954), the observer was kept rigorously *outside* the system. Objectivist protocol held that information flows from the system to a detached watcher who reports what is there without affecting it. [[N. Katherine Hayles]] argues that this exclusion was not innocent but constitutive: the scientific frame "had been constructed so as to ignore the observer," which is the same gesture by which information was stripped of its body and the human reframed as an information-processing machine. The Macy participants sensed the danger of letting the observer back in — once admitted, "cracks in the frame radiate outward until the perspectives that controlled context are fractured" — and so [[Reflexivity]] was quarantined as unquantifiable subjectivity.

The **second wave** (1960–1985) is defined by drawing the observer *into* the picture, and it is here that [[Heinz von Foerster]] and [[Humberto Maturana]] do the constitutive work. Von Foerster, coeditor of the Macy transcripts, made the inclusion of the observer the program of "second-order cybernetics" — cybernetics applied to the cyberneticians themselves — and saw it as the central issue of the field. Maturana supplied the maxim that anchors the whole turn: "Everything said is said by an observer." In [[Autopoiesis]] the observer is not an optional add-on but the condition of cognition itself: "The observer is a living system and any understanding of cognition as a biological phenomenon must account for the observer and his role in it." Crucially, information, coding, teleology, time, and causality are demoted to *inferences drawn by an observer* rather than properties intrinsic to living processes — which is how the second wave begins to reattach information to embodied life (see [[The Body as Data]], [[Embodiment vs Information]]).

A defining feature of Hayles's account is that Maturana's observer is **positional, not psychoanalytic**. Where Lawrence Kubie's Macy-era reflexivity invested every utterance with the speaker's unconscious, Maturana's observer "does not have psychological depth or specificity." Hayles likens it instead to "the observer that Albert Einstein posits in the special theory of relativity" — a generic marker such that "any individual of that species occupying that position would see more or less the same thing." Construction of reality "depends on positionality rather than personality"; the opposite of objectivism here "is not subjectivism but relativism." This Einsteinian, depersonalized observer is what lets reflexivity be made operational without collapsing into solipsism — though Hayles notes the cost, since the inertness of "the observer" also flattens Maturana's account of language and transformation.

In the **third wave** (Artificial Life) the observer "retreats to the periphery, with a consequent loss of the sophistication that Maturana brought to epistemological questions." Yet it does not disappear: "The observer has, however, not altogether vanished from the scene, remaining in the picture as narrator and narratee of stories about Artificial Life." The strong claim that code is alive turns out to rest on the watcher — "It's in the eye of the beholder. It's not the system, it's the observer" — and Hayles makes the observer her wedge for re-embodiment, concluding that once "we acknowledge that the observer must be part of the picture, bodies can never be made of information alone, no matter which side of the computer screen they are on."
...
- [[Reflexivity]] — the *movement* of folding the observer into the system; the observer is the figure that reflexivity moves. (Distinct: reflexivity is the operation, the observer is the one operated on and operating.)
- [[Autopoiesis]] — the second-wave theory in which the observer is the necessary correlate of any account of cognition.
...
- [[Distributed Cognition]] — the dethroning of the single, unified observer: cognition spread across body, instruments, and environment rather than centered in one watcher. Where the observer is a positional point, distributed cognition disperses the point of view itself.
- The first-wave **objectivist** stance — the observer held *outside* the system, reporting a "perceiver-independent world" — is the position the second wave overturns.

## Questions It Raises

- If "everything said is said by an observer," and information, coding, and teleology are only an observer's inferences, does the second-wave observer dissolve the [[Embodiment vs Information]] divide — or merely relocate it inside the observer's own body? (ties to [[The Body as Data]])
...
Supports: The second-wave thesis that the observer must be drawn into any account of cognition — the figure's inclusion is constitutive, not optional. Label: `Directly stated`.
...
> Once the observer is made a part of the picture, cracks in the frame radiate outward until the perspectives that controlled context are fractured as irretrievably as a safety-glass windshield hit by a large rock.

Supports: The first-wave fear that admitting the observer would shatter objectivist control of context — why the Macy group kept the observer outside the system. Label: `Directly stated`.
...
> Heinz von Foerster, in his letter to Fremont-Smith, saw the inclusion of the observer as the central issue of cybemetics.

Supports: Von Foerster's framing of the observer's inclusion as cybernetics' central issue — the claim the whole concept note is built on. Label: `Directly stated`.
...
> The observer has, however, not altogether vanished from the scene, remaining in the picture as narrator and narratee of stories about Artificial Life.

Supports: The third-wave fate of the observer — retreated to the periphery but surviving as narrator/narratee of AL stories. Label: `Directly stated`.
