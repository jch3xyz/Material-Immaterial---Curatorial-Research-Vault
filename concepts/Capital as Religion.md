...
Capital, in Byung-Chul Han's reading of Walter Benjamin, becomes a new transcendence — a God before whom all are debtors and guilty (*Schuld*) — running not as a religion of atonement but as a cult that "creates guilt, not atonement," so that perpetual debt perpetuates unfreedom.
...
Han then poses the question through which Benjamin enters: "Could it be that Capital is a new God, making us guilty and debt-ridden again? Walter Benjamin held that capitalism is a religion." He quotes Benjamin's thesis directly — capitalism is "the 'first case of a cult that creates guilt, not atonement'" (*der erste Fall eines nicht entsühnenden, sondern verschuldenden Kultus*) — and draws the consequence: "Since there is no possibility of relieving debt and guilt, the state of unfreedom perpetuates itself." Because the cult cannot absolve, the guilt it produces becomes total: "A vast sense of guilt that is unable to find relief seizes on the cult, not to atone for this guilt but to make it universal." (Label: `Directly stated`.)
...
- [[Freedom vs Control]] — Capital-as-religion is the pole that converts freedom into servitude: the debtor's guilt "destroys freedom," and politics becomes "the handmaiden of Capital."

## Questions It Raises

- If the cult of Capital "creates guilt, not atonement," is there any exit — any ritual of debt-forgiveness or *Aufhebung* — or is the perpetuation of unfreedom structurally guaranteed by the absence of atonement?
...
> Capital therefore represents a new kind of transcendence, which entails a new form of subjectivation. We are being expelled from the sphere of lived immanence - where life relates to life instead of subjugating itself to external ends.

Supports: Grounds the claim that Capital becomes a new transcendence/master before which the subject is reconstituted, the precondition for reading it as a religion. Paired with Han's later statement that "freedom vanishes just as soon as Capital achieves the status of being a new transcendency - a new master." Label: `Directly stated`.
...
Supports: Supplies the *Schuld* (debt/guilt) equation and the link between indebtedness and the destruction of freedom — guilt before God transposed into debt before Capital. Label: `Directly stated`.
