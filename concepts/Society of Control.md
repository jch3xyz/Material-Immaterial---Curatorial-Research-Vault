...
The political formation in which power operates not through enclosure, isolation, and discipline but through continuous mutual illumination, voluntary self-exposure, and a "dialectic of freedom" in which "freedom turns out to be a form of control."
...
- [[Digital Panopticon]] — the surveillance apparatus of the society of control; its aperspectival, decentered architecture.
- [[Aperspectival Panopticon (Han)]] — Han's structural definition of control without a central gaze: "utter illumination of everyone from everywhere, which anyone can perform."
- [[Hypercommunication]] — the medium of control; replaces isolation as the guarantor of transparency.
- [[Auto-Exploitation]] — the economic correlate; "the exploiter is simultaneously the exploited," and auto-illumination is more efficient than allo-illumination.
- [[Transparency]] — the social imperative the society of control enforces; "the society of transparency is a society of mistrust and suspicion."
- [[Gleichschaltung]] — the endpoint of total control: "Total control destroys the freedom of action and ultimately leads to Gleichschaltung."

## Opposing Concepts

- [[Freedom vs Control]] — the tension the society of control dissolves rather than resolves: freedom is not abolished but revealed as itself a mode of control.
- Disciplinary society — the Foucauldian formation the society of control supersedes (see [[Byung-Chul Han and Michel Foucault]]); enclosure, isolation, and the despotic gaze give way to networked, voluntary, decentered illumination. *Strongly implied* — Han names "disciplinary society" but not Foucault in the cited text.

## Questions It Raises

- If control now works through voluntary self-exposure and the "sensation of freedom," what political vocabulary remains to name it as unfreedom — and does the embodied subject still register coercion when it feels like desire? (desire; visibility vs understanding)
- When the body is rendered as continuously displayed and tracked data on the "panoptic market," does control act on subjects or on the data-doubles they emit — and which one is actually being modulated? (the body as data; embodiment)
...
Supports: Defines the society of control by its mode of operation — voluntary, self-generated self-exposure rather than external constraint — which is the core of the concept. Label: `Directly stated`.
...
Supports: Grounds the contrast with disciplinary society — isolation and silence give way to networked hypercommunication — and ties the society of control to the panoptic and transparency arguments. Label: `Directly stated`.
...
Supports: Establishes the economic and psychological mechanism of control — self-illumination experienced as freedom — that links the society of control to auto-exploitation and the achievement-subject. Label: `Directly stated`.
...
> Communication and commerce, freedom and control, collapse into one. ... Herein lies the dialectic of freedom. Freedom turns out to be a form of control.

Supports: States the defining inversion of the concept — the dissolution of the gap between freedom and control — which the brief definition centers on. Label: `Directly stated`.
