...
The worldview — held by Edward Fredkin, Stephen Wolfram, Hans Moravec, Marvin Minsky, and others — in which the essential function of humans, machines, and the cosmos alike is processing information, so that "we are the programs" run by a vast cosmic computer; Hayles treats it not as a discovery but as a contingent, socially constructed ideology that becomes dangerous precisely when it privileges information over everything else.

## Longer Explanation

In the final movement of *How We Became Posthuman*, Hayles names "the computational universe" as the emergent worldview toward which the research she has been surveying — [[Artificial Life]], evolutionary psychology, [[Marvin Minsky]]'s "society of mind," [[Hans Moravec]]'s robotics — is "edging." Its founding premise is a single, totalizing equation: "In the computational universe, the essential function for both intelligent machines and humans is processing information. Indeed, the essential function of the universe as a whole is processing information." This is the move that completes the refashioning of the human into the [[Posthumanism|posthuman]]. By making information-processing the common denominator of mind, matter, and cosmos, it produces the equality on which the cybernetic dream rests: humans and intelligent machines "can both feel at home" because "not only our world but the great cosmos itself is a vast computer and that we are the programs it runs." `Directly stated`.

The worldview is built from the bottom up. At its base lie cellular automata — von Neumann's grids of simple on-off cells whose massive material automaton was "reduced" to "undifferentiated cells with bodies so transparent that they were constituted as squares marked off on graph paper." From their interactions, complexity emerges. [[Edward Fredkin]] takes the decisive step of "seeing in cellular automata the foundational structure from which everything in the universe is built up," and asserts "that reality is a software program run by a cosmic computer, whose nature must forever remain unknown to us because it lies outside the structure of reality." On this view, "humans are programs that run on the cosmic computer," and phenomenological experience is "itself a kind of illusion, covering an underlying reality of simple forms." Hayles shows that this rests on an ancient Platonic inheritance, reactivated in [[Christopher Langton]]'s "strong claim" that the logical form of an organism "can be separated from its material basis of construction" and that aliveness is "a property of the former, not of the latter": "Form can logically be separated from matter; form is privileged over matter; form defines life, whereas the material basis merely instantiates life." The computational universe is thus the metaphysical apotheosis of the [[Material vs Immaterial|form/matter dichotomy]] — the point at which information, "defined in theoretic terms . . . as a probability function and thus as a pattern or form rather than as a materially instantiated entity," is installed as the substance of reality itself. `Directly stated`.
...
- **[[Edward Fredkin]]** — the purest proponent: reality is "a software program run by a cosmic computer," cellular automata are the foundational structure of all matter and energy, and humans are "programs that run on the cosmic computer." Notably, Fredkin's cosmic computer puts "the ultimate material embodiment out of our reach," so even his information-metaphysics carries a residue of the unknowable material.
- **Stephen Wolfram** (as situated by Hayles) — belongs to the cellular-automata lineage that treats simple computational rules as the generative substrate of the universe's complexity.
...
- [[Posthumanism]] — the computational universe is the worldview that completes the posthuman refashioning of the human; "the machine becomes the model for understanding the human."
- [[The Body as Data]] — the computational universe applies to the human body: if reality is informational pattern, the body becomes a recodable, in-principle-disposable instantiation of code.
- [[Information (Hayles)]] — the *technical* concept the computational universe absolutizes; Hayles distinguishes information as a socially constructed, medium-dependent concept from its ideological inflation into the essence of the cosmos.
- [[Artificial Life]] — the *field* whose "strong claim" that the computer "creatures" are "actually alive," together with its bottom-up cellular-automata methods, supplies the working materials of the computational universe.
- [[Material vs Immaterial]] — the computational universe is the form/matter dichotomy raised to metaphysics: form is privileged, matter "merely instantiates."
- [[Cybernetics]] — the tradition (first- and second-wave) that is the "grandparent and parent" of this worldview; the computational universe "realizes the cybernetic dream" in a way different from what [[Norbert Wiener]] imagined.

## Opposing Concepts

- [[Embodiment]] — Hayles's direct counter: the "resistance of materiality," the "murmurs from the body," and the insistence that "human mind without human body . . . doesn't exist." The computational universe privileges disembodied information; embodiment names everything it erases. The two are the poles of [[Embodiment vs Information]].

## Questions It Raises

- If the computational universe is a "useful heuristic" that turns "dangerous" only as ideology, where exactly is the line — can one compute models of life without committing to the metaphysics that "we are the programs" the cosmos runs? (ties to information vs materiality)
- The worldview depends on information being "defined . . . as a pattern or form rather than as a materially instantiated entity." If, as Hayles insists, information "is a socially constructed concept" that "could have been, and was, given different definitions," does the entire computational universe rest on a historical accident of the Macy Conferences? (ties to information vs materiality; the body as data)
...
> In the computational universe, the essential function for both intelligent machines and humans is processing information. Indeed, the essential function of the universe as a whole is processing information.

Supports: The defining equation of the worldview — information-processing as the common essence of machines, humans, and the cosmos. Grounds the brief definition and the opening of the longer explanation. Label: `Directly stated`.
...
> That equality derives from the view that not only our world but the great cosmos itself is a vast computer and that we are the programs it runs.

Supports: The "cosmic computer / we are the programs" figure at the heart of the concept — the totalizing image that makes humans and machines equivalent. Label: `Directly stated`.
...
> Fredkin, for example, says that reality is a software program run by a cosmic computer, whose nature must forever remain unknown to us because it lies outside the structure of reality, whose programs it runs.

Supports: Anchors Fredkin as the purest proponent and supplies the precise formulation of reality-as-software-on-a-cosmic-computer. Label: `Directly stated`.
...
> It will now perhaps be clear why the most prized functionality is the ability to process information, for in the computational universe, information is king.

Supports: Establishes the explicit hierarchy of values internal to the worldview — information ranked above all else. Sets up the danger Hayles diagnoses. Label: `Directly stated`.
...
Supports: The core of Hayles's critique — the worldview as contingent, socially constructed ideology rather than fact, dangerous precisely when it privileges information over everything else; and her embodied counter ("the world have [not] lost theirs"). Label: `Directly stated`.
...
> Form can logically be separated from matter; form is privileged over matter; form defines life, whereas the material basis merely instantiates life.

Supports: Locates the computational universe's metaphysics in the Platonic form/matter hierarchy, tying it to [[Material vs Immaterial]] and showing why information is installed as the substance of reality. Label: `Directly stated`.
