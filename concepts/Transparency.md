...
Han never offers a single tidy definition of [[Transparency]]; instead he layers overlapping framings across the book, each one pulling a different operational consequence out of the same dispositive. In the [[03 Preface|Preface]] he names it bluntly: "Transparency is a neoliberal dispositive. It forces everything inward in order to transform it into information." This is the master formula — transparency is not a virtue of openness but an economic infrastructure for converting interiority, otherness, and secrecy into circulable [[Information]], because "more information and communication mean more productivity and acceleration." `Directly stated`.

In Chapter 1 the dispositive becomes a [[Positivity|positivity]]-engine: "Transparency is a systemic compulsion gripping all social processes and subjecting them to a deep-reaching change." Things prove transparent when they "shed all negativity, when they are smoothed out and leveled, when they do not resist being integrated into smooth streams of capital, communication, and information." This is why Han calls the society of transparency an "[[Hell of the Same]]": the [[The Other|Other]] is not censored but flattened into likeness so that "a chain reaction of likeness" can run at maximum velocity. `Directly stated`.
...
Supports: Anchors the framing of transparency as *neoliberal dispositive* and an information-conversion machine — the most economically explicit of Han's framings. Label: `Directly stated`.
...
Supports: Grounds the *lightless radiation* variant and the distinction from Enlightenment-style illumination — essential for any later note on [[Light]], [[Visibility]], or [[Information]]. Label: `Directly stated`.
...
> Aperspectival, penetrating illumination [Durchleuchtung] proves more effective than perspectival surveillance because it means utter illumination of everyone from everywhere, which anyone can perform.

Supports: Names the panoptic-economic variant: transparency as *aperspectival illumination* that makes the [[Digital Panopticon]] efficient precisely because it is decentered. Label: `Directly stated`.
...
Supports: Supplies the psychological-intimate formula of transparency — the felt freedom that turns out to be the most efficient form of control, linking [[Transparency]] to [[Auto-Exploitation]]. Label: `Directly stated`.
