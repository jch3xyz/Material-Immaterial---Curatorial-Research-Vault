...
"Information" names several distinct concepts that this note holds together without collapsing. For **[[Byung-Chul Han]]**, information is *positivized, operationalized language* — additive, naked, post-hermeneutic discourse stripped of the negativity through which truth, knowledge, or insight would transform what exists. For **[[N. Katherine Hayles]]**, information is the *Shannon-Wiener information-theoretic construct* — a probability function, a disembodied pattern imagined to circulate unchanged between material substrates, which she treats as a contingent historical reification rather than a metaphysical given. Han's sense is a critique of language under transparency; Hayles's sense is a critique of the cybernetic "leap from embodied reality to abstract information." A third, art-historical sense belongs to **[[Lucy Lippard]]** and the conceptualists of *[[Six Years]]*: information here is an *aesthetic* — an "informational, documentary idiom" in which the work, no longer dependent on physical presence, exists as "primary information" carried by catalogues, texts, and documents rather than objects. A fourth, *theological* sense belongs to **[[Meghan O'Gieblyn]]** and *[[God Human Animal Machine]]*: the same Shannon-Wiener construct Hayles diagnoses, but read as a substitute for a metaphysical absolute — once Shannon strips information of meaning and the Macy Conferences decouple it from matter, information "became, in other words, the materialist's substitute for the soul" (Ch. 4) and swells into "the ultimate metaphor" and even a "third substance" said to underlie reality itself (Ch. 7). O'Gieblyn's "information" is closest to Hayles's (it is the same cybernetic genealogy, and she cites Hayles directly), but where Hayles contests the disembodiment on behalf of [[Embodiment|embodiment]], O'Gieblyn reads it as the latest form taken by an old religious longing. None of these is the others, but all converge in privileging weightless pattern over the object: see [[#Hayles on Information]], [[#Information in Conceptual Art (Lippard)]], [[#Information as the Substitute for the Soul (O'Gieblyn)]], the technical definition at [[Information (Hayles)]], and the cross-links to [[Dematerialization]] and [[The Document (Conceptual Art)]]. Han returns to information a *second* time in *[[Psychopolitics]]*, no longer chiefly as positivized language but as the matter of [[Dataism|dataism]] — the creed that data form "a transparent and reliable lens" replacing causality with correlation and theory with data, and the substance of an [[Immaterial Labour|immaterial production]] whose products "are not material objects, but immaterial ones - for instance, information and programs"; see [[#Psychopolitics (Han) — data positivism and the end of theory]]. A fifth, *cosmological* sense belongs to **[[Yuval Noah Harari]]** and *Homo Deus*: where Han, Hayles, and O'Gieblyn each *contest* the elevation of weightless pattern, Harari reports a creed that *affirms* it without reservation. For the [[Dataism|Dataism]] he diagnoses, "the universe consists of data flows, and the value of any phenomenon or entity is determined by its contribution to data processing" (Ch. 11) — information is not a mode of language or a reified construct but the substance of reality itself, and its unobstructed circulation is raised to the supreme value: "the greatest sin is to block the data flow" (Ch. 11). This is the same weightlessness the other four authors distrust, now installed as a religion's "greatest good"; the new value it confers — [[Freedom of Information|freedom of information]], "given to information" rather than to humans — is what the rest of this note's authors would resist. See [[#Information Flow as the Supreme Value (Harari)]]. A sixth, *affirmative-metaphysical* sense belongs to **[[Ray Kurzweil]]** and *[[The Singularity Is Near]]*: where Harari only *reports* the data religion, Kurzweil *holds* the metaphysics as his own. He describes himself in Ch. 7 as "a 'patternist,' someone who views patterns of information as the fundamental reality" (Prologue), and extends this to the self: "at least for bits of information, which essentially is what we comprise" (Prologue). It supplies the proponent's pole the other five authors variously contest — but Kurzweil also contributes a precise technical apparatus, distinguishing *information* from both *order* (information that fits a purpose) and *noise* (a random, information-free sequence). The heavier metaphysics — the [[The Computational Universe|computational-universe]] thesis and the [[Material vs Immaterial]] inversion of matter and information — are routed to those notes; here only the *informational* core is recorded. See [[#Information as the Fundamental Reality (Kurzweil)]].

## Brief Definition

For [[Byung-Chul Han]], **information** is positivized, operationalized language — additive, naked, and lacking the negativity through which truth, [[Knowledge (Erkenntnis)|knowledge]], or [[Insight|insight]] would transform what exists.

## Longer Explanation

Han defines information by what it lacks. In *[[The Transparency Society]]*, he writes that "the society of transparency is the society of information. Information is a phenomenon as such insofar as it lacks all negativity. It amounts to positivized, operationalized language" (Ch. 7). Information is not a neutral substrate of contemporary life but a specific mode of language stripped of ambivalence, hermeneutic depth, and the capacity to refuse, withhold, or wound. It belongs to Han's broader diagnosis of [[Positivity|positivity]]: matters become transparent "when they are smoothed out and leveled, when they do not resist being integrated into smooth streams of capital, communication, and information" (Ch. 1). Information is the linguistic form proper to that smooth circulation. `Directly stated`.
