...
Direct citation and conceptual grounding. Han explicitly quotes Hegel in [[The Transparency Society]] and uses Hegelian categories — above all the [[Negativity]] of Spirit — as the load-bearing scaffolding for his entire critique of [[Positivity]] and the [[Transparency|Society of Transparency]].

## Explanation

Han's diagnosis of contemporary society as a "[[Positivity|Society of Positivity]]" is structured by a two-step appropriation of Hegel. First, in Chapter 1, Han invokes Hegel's account of Spirit as that which has power "only by looking the negative in the face and tarrying with it," in order to argue that the dialectical [[Tarrying with the Negative]] has been displaced by a hyperactive racing in the positive (`Directly stated`). Second, in Chapter 5, he invokes Hegel's claim that negativity is internal to thinking — that thinking is the [[Becoming-Different-From-Oneself]] which transforms — in order to distinguish [[Thinking vs. Calculation|thinking]] from mere calculation, and to argue that [[Acceleration]] is parasitic on the elimination of negativity (`Directly stated`). Hegel is therefore not one reference among others for Han: he supplies the [[Positivity vs Negativity|Negativity vs. Positivity]] opposition through which the [[Transparency]] critique is articulated. The relationship is one of direct citation in the service of a diagnostic deployment — Han borrows Hegel's ontology of Spirit and turns it into a critical measure against which the present is found wanting.

## Source Passages

From Chapter 1, on Spirit and the dialectic:
...
From Chapter 5, on thinking and self-difference:
...
Supports: Establishes Han's first Hegelian appropriation — Spirit as that which tarries with the negative — and shows that Han reads the [[Transparency|Society of Transparency]] as the historical liquidation of this dialectical patience. The opposition between Hegelian slowness and contemporary [[Acceleration]] is articulated here directly. Label: `Directly stated`.
